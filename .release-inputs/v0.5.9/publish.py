...
try:
    ...
    if matches:
        ...
        release=api(f'repos/{repo}/releases',dict(tag_name=meta['tag'],target_commitish=os.environ['GITHUB_SHA'],name='EATWF Launcher 0.5.9',body=(base/'RELEASE-NOTES.md').read_text(),draft=True,prerelease=True))
